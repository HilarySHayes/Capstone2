...
def save_cluster_plot(person, epsilon, central_lat, central_long, colormap, filename, gain_threshold=400, steps=10):
    ...
    m = plot_multiple_clusters(person_df, peaks, central_lat, central_long, colormap, cluster_series, steps)
...
if __name__ == '__main__':
    ...
    save_cluster_plot(person, epsilon, central_lat, central_long, colormap, 'Summit')
